...
var viewStudentListController= require('./controller/viewStudentList');
var demoControllerExample=require('./controller/demoAttendance');
var calenderDataController=require('./controller/calenderData')
...
app.post('/api/demoAttendance', demoControllerExample.demoAttendance);
...
app.get('/api/calenderData',calenderDataController.calenderData);

app.post('/api/takeAttendance', takeAttendanceController.takeAttendance);

app.post('/api/viewStudentList', viewStudentListController.viewStudentList);
